...
TRANSLATIONS = {
    "vi": {
        ...
        # === BỔ SUNG CHO FLASHCARD & GRADE ===
        "flash_empty_option": "Đáp án khác",
        "flash_question_badge": "CÂU HỎI",
        "flash_notice": "Thông báo",
        "flash_choose_course": "Chọn khóa học để ôn tập flashcard:",
        "flash_choose_lesson": "Chọn bài học để bắt đầu làm bài:",
        "flash_empty_lesson": "Chưa có bài học nào trong khóa học này.",
        "flash_lesson_empty_cards": "Bài học này chưa có flashcard.\nVào Khóa học → bài học đó → nhấn nút Flashcard để tạo.",
        "flash_result_msg": "🎉 Chúc mừng bạn đã hoàn thành!\nKết quả: {score}/{total} câu trả lời đúng.",
        "flash_file_filter": "Tài liệu (*.pdf *.docx)",
        "flash_deck_name_dialog_title": "Đặt tên bộ học tập",
        "flash_deck_name_dialog_msg": "Nhập tên cho bộ câu hỏi mới:",
        "flash_default_file_deck_title": "Tài liệu từ File",
        "flash_ai_success_msg": "Đã khởi tạo bộ bài '{title}' với {saved} câu hỏi trắc nghiệm.",
        "flash_ai_error_msg": "Không thể sinh câu hỏi tự động:\n{err_msg}",
        "flash_default_deck_title": "Bộ flashcard",
        "flash_status_done": "✅ Đã hoàn thành",
        "flash_status_pending": "⏳ Chưa hoàn thành",
        "flash_card_count": "{count} câu hỏi",
        "flash_delete_deck_tooltip": "Xóa bộ flashcard",
        "success": "Thành công",

        "grade_note_weight": "💡 Nếu không có CC/BT, trọng số tự động điều chỉnh.",
        "grade_no_score": "Không có",
        "grade_err_empty_name": "Vui lòng nhập tên môn học.",
        "grade_hs_avg_all": "Điểm trung bình tất cả môn",
        "grade_sv_convert": "Quy đổi hệ 10: {gpa10}   •   Xếp loại: {rank}",
        "grade_semester": "Học kỳ",
        "grade_rename_semester": "✏️  Đổi tên học kỳ",
        "grade_delete_semester": "🗑️  Xóa học kỳ",
        "grade_rename_semester_title": "Đổi tên học kỳ",
        "grade_rename_semester_label": "Tên mới:",
        "grade_delete_semester_msg": "Xóa học kỳ '{name}' và toàn bộ môn học?\nHành động này không thể hoàn tác.",
        "grade_hs_stats": "Số môn: {count}   •   ĐTB: {overall}",
        "grade_sv_stats": "Số môn: {count}   •   TC: {credits}   •   GPA 10: {gpa10}   •   GPA 4: {gpa4}",
        "grade_sv_stats_empty": "Số môn: {count}   •   TC: {credits}",
        "grade_add_semester": "+ Thêm học kỳ",
        "grade_add_semester_title": "Thêm học kỳ",
        "grade_add_semester_label": "Tên học kỳ (ví dụ: Học kỳ 1 – 2024/2025):",
        "grade_empty_hint": "Nhấn \"+ Thêm học kỳ\" để bắt đầu quản lý điểm theo từng kỳ.",
    ...
    "en": {
        ...
        # === BỔ SUNG CHO FLASHCARD & GRADE ===
        "flash_empty_option": "Other option",
        "flash_question_badge": "QUESTION",
        "flash_notice": "Notice",
        "flash_choose_course": "Select a course to review flashcards:",
        "flash_choose_lesson": "Select a lesson to start:",
        "flash_empty_lesson": "No lessons in this course yet.",
        "flash_lesson_empty_cards": "This lesson has no flashcards.\nGo to Courses → Lesson → click Flashcard to create.",
        "flash_result_msg": "🎉 Congratulations!\nResult: {score}/{total} correct answers.",
        "flash_file_filter": "Documents (*.pdf *.docx)",
        "flash_deck_name_dialog_title": "Name your deck",
        "flash_deck_name_dialog_msg": "Enter name for the new flashcard deck:",
        "flash_default_file_deck_title": "Document from File",
        "flash_ai_success_msg": "Created deck '{title}' with {saved} questions.",
        "flash_ai_error_msg": "Cannot generate questions automatically:\n{err_msg}",
        "flash_default_deck_title": "Flashcard Deck",
        "flash_status_done": "✅ Completed",
        "flash_status_pending": "⏳ Pending",
        "flash_card_count": "{count} questions",
        "flash_delete_deck_tooltip": "Delete deck",
        "success": "Success",

        "grade_note_weight": "💡 If no Attendance/Assignment, weights adjust automatically.",
        "grade_no_score": "None",
        "grade_err_empty_name": "Please enter the subject name.",
        "grade_hs_avg_all": "Average score of all subjects",
        "grade_sv_convert": "10-point scale: {gpa10}   •   Rank: {rank}",
        "grade_semester": "Semester",
        "grade_rename_semester": "✏️  Rename semester",
        "grade_delete_semester": "🗑️  Delete semester",
        "grade_rename_semester_title": "Rename Semester",
        "grade_rename_semester_label": "New name:",
        "grade_delete_semester_msg": "Delete semester '{name}' and all subjects?\nThis cannot be undone.",
        "grade_hs_stats": "Subjects: {count}   •   Avg: {overall}",
        "grade_sv_stats": "Subjects: {count}   •   Credits: {credits}   •   GPA 10: {gpa10}   •   GPA 4: {gpa4}",
        "grade_sv_stats_empty": "Subjects: {count}   •   Credits: {credits}",
        "grade_add_semester": "+ Add Semester",
        "grade_add_semester_title": "Add Semester",
        "grade_add_semester_label": "Semester name (e.g., Semester 1 - 2024/2025):",
        "grade_empty_hint": "Click \"+ Add Semester\" to start managing grades.",
    ...
    "cn": {
        ...
        # === BỔ SUNG CHO FLASHCARD & GRADE ===
        "flash_empty_option": "其他选项",
        "flash_question_badge": "问题",
        "flash_notice": "通知",
        "flash_choose_course": "选择复习闪卡的课程：",
        "flash_choose_lesson": "选择开始的课程：",
        "flash_empty_lesson": "此课程还没有课时。",
        "flash_lesson_empty_cards": "此课时没有闪卡。\n转到 课程 → 课时 → 点击 闪卡 创建。",
        "flash_result_msg": "🎉 恭喜完成！\n结果：答对 {score}/{total} 题。",
        "flash_file_filter": "文档 (*.pdf *.docx)",
        "flash_deck_name_dialog_title": "命名套牌",
        "flash_deck_name_dialog_msg": "输入新闪卡套牌的名称：",
        "flash_default_file_deck_title": "来自文件的文档",
        "flash_ai_success_msg": "已创建套牌 '{title}'，包含 {saved} 个问题。",
        "flash_ai_error_msg": "无法自动生成问题：\n{err_msg}",
        "flash_default_deck_title": "闪卡套牌",
        "flash_status_done": "✅ 已完成",
        "flash_status_pending": "⏳ 未完成",
        "flash_card_count": "{count} 个问题",
        "flash_delete_deck_tooltip": "删除套牌",
        "success": "成功",

        "grade_note_weight": "💡 如果没有考勤/作业，权重会自动调整。",
        "grade_no_score": "无",
        "grade_err_empty_name": "请输入科目名称。",
        "grade_hs_avg_all": "所有科目的平均分",
        "grade_sv_convert": "10分制：{gpa10}   •   等级：{rank}",
        "grade_semester": "学期",
        "grade_rename_semester": "✏️  重命名学期",
        "grade_delete_semester": "🗑️  删除学期",
        "grade_rename_semester_title": "重命名学期",
        "grade_rename_semester_label": "新名称：",
        "grade_delete_semester_msg": "删除学期 '{name}' 及其所有科目？\n此操作无法撤销。",
        "grade_hs_stats": "科目：{count}   •   平均分：{overall}",
        "grade_sv_stats": "科目：{count}   •   学分：{credits}   •   绩点 10: {gpa10}   •   绩点 4: {gpa4}",
        "grade_sv_stats_empty": "科目：{count}   •   学分：{credits}",
        "grade_add_semester": "+ 添加学期",
        "grade_add_semester_title": "添加学期",
        "grade_add_semester_label": "学期名称（例如：第一学期 - 2024/2025）：",
        "grade_empty_hint": "点击 \"+ 添加学期\" 开始按学期管理成绩。",
